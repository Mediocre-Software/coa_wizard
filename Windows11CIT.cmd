@echo off
echo Warning This script is for Windows 11 PRO CITIZENSHIP edition only!
echo.
...
net use y: \\172.16.0.78\mdos\Script\WIN11Pro_Citizenship /user:Discount-PC-FFKI\coa BigStart2020
