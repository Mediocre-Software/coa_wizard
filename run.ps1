...
Add-Type -AssemblyName PresentationCore,PresentationFramework
      ...
      $msgBody = "Did You Remember to Attach COA Sticker for Digital License?"
      $msgTitle = "Don't Forget..."
      $msgButton = 'YesNo'
      $msgImage = 'Question'
      $msgBody2 = "Good Job!"
      $msgTitle2 = "Don't Forget..."
      $msgButton2 = 'OK'
      $msgImage2 = 'Exclamation'
    $Result = [System.Windows.MessageBox]::Show($msgBody,$msgTitle,$msgButton,$msgImage)
    Write-Host "The User Stated That, : $Result [" ($result).value__ "]"
       
      If ($Result -eq 6) {
    [System.Windows.MessageBox]::Show($msgBody2,$msgTitle2,$msgButton2,$msgImage2)
    }